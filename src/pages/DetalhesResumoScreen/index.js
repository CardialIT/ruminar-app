        ...
        <View style={styles.containerProps}>
          ...
          <View style={styles.containerPropsItens}>
            ...
            <View style={styles.itensPercentage}>
              <Text style={styles.itensN}>Peso Médio: </Text>
              <Text style={styles.percetangeN}>{item.peso_medio} em Kg</Text>
            </View>

            <View style={styles.itensPercentageC}>
              <Text style={styles.itensN}>Produção Estimada: </Text>
              <Text style={styles.percetangeN}>{item.producao_estimada} em litros</Text>
            </View>

            <View style={styles.itensPercentage}>
              <Text style={styles.itensN}>Del: </Text>
              <Text style={styles.percetangeN}>{item.del} em dias</Text>
            </View>

            <View style={styles.itensPercentageC}>
              <Text style={styles.itensN}>Amido Estimado: </Text>
              <Text style={styles.percetangeN}>{item.amido_estimado} % </Text>
            </View>            
...
{/* 
            ...
            <View style={styles.itensPercentage}>
              ...
              <View style={styles.itensPercentageC}>
              <Text style={styles.itensR}>Matéria Seca Faltando: </Text>
              <Text style={styles.percetangeR}>{item.materia_seca_faltando} em MS</Text>
            </View>
